...
@Component({
  selector: 'app-created-itinerary-map',
  templateUrl: './created-itinerary-map.component.html',
  styleUrl: './created-itinerary-map.component.css',
})
export class CreatedItineraryMapComponent {
  ...
  markers: MapMarkerModel[] = [
    ...
    //   id: '2',
    //   icon: {
    //     url: ICONS.startMarkerImage,
    //     size: new google.maps.Size(40, 40),
    //     scaledSize: new google.maps.Size(30, 30),
    //   },
    //   position: { lat: 24.9607, lng: 67.9011 },
    //   radius: 100,
  ...
  ngOnInit(): void {
    ...
    // this.itineraryService.getMapData().subscribe((data) => {
